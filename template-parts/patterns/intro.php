<?php
/**
 * The Basic Intro Pattern Which Might Fit At The First Of The Page
...
<!-- wp:paragraph {"className":"py-4","style":{"elements":{"link":{"color":{"text":"var:preset|color|black"}}}},"textColor":"black"} -->
<p class="py-4 has-black-color has-text-color has-link-color">In Short I am Lorem ipsum, dolor sit amet consectetur adipisicing..</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|black"}}}},"textColor":"black"} -->
<p class="has-black-color has-text-color has-link-color">Asia, Earth</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|black"}}}},"textColor":"black"} -->
<p class="has-black-color has-text-color has-link-color">Available for New Projects</p>
<!-- /wp:paragraph -->

<!-- wp:social-links {"className":"is-style-default py-2","layout":{"type":"flex","flexWrap":"wrap"}} -->
<ul class="wp-block-social-links is-style-default py-2"><!-- wp:social-link {"url":"https://facebook.com","service":"facebook"} /-->
